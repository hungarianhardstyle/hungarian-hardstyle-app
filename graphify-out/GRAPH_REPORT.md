...
### Community 4 - "organizer.dart"
Cohesion: 0.04
Nodes (46): event.dart, 0, city, country, description, excerpt, false, featured (+38 more)
...
Cohesion: 0.06
Nodes (43): DocumentSnapshot, _Composer, _PostAuthorLabels, _ProfileAvatar, _action, CommunityBlockedUsersScreen, CommunityConnectionsScreen, CommunityPublicFriendsScreen (+35 more)
...
### Community 16 - "genre_discovery_screen.dart"
Cohesion: 0.07
...
### Community 24 - "artists_screen.dart"
Cohesion: 0.09
...
### Community 30 - "voting_screen.dart"
Cohesion: 0.11
Nodes (20): votingProvider, votingServiceProvider, build, _busyCategory, _category, createState, _link, _newsletterAsked (+12 more)
...
### Community 46 - "communityServiceProvider"
Cohesion: 0.15
Nodes (17): communityAuthProvider, communityPostsProvider, communityServiceProvider, ConsumerWidget, build, CommunityAdminScreen, _CommunityAdminScreenState, CommunityAvatarButton (+9 more)

### Community 47 - "tagged_news_screen.dart"
Cohesion: 0.12
Nodes (16): build, createState, dispose, _error, _hasMore, _hasTag, initState, _loading (+8 more)

### Community 48 - "mobile_ad_banner.dart"
Cohesion: 0.15
Nodes (15): BannerAd?, int?, adsEnabledProvider, _ad, build, createState, dispose, _ensureAd (+7 more)

### Community 49 - "news_detail_screen.dart"
Cohesion: 0.12
...
### Community 54 - "organizers_screen.dart"
Cohesion: 0.15
...
Cohesion: 0.21
Nodes (13): ConsumerState, ConsumerStatefulWidget, wordpressServiceProvider, EventDetailScreen, _EventDetailScreenState, GenreDiscoveryScreen, _GenreDiscoveryScreenState, CommunityUsersScreen (+5 more)
...
### Community 60 - "State"
Cohesion: 0.22
Nodes (13): GalleryScreen, _GalleryScreenState, SettingsScreen, _SettingsScreenState, BrandLoadingIndicator, _BrandLoadingIndicatorState, PostEmbedCard, _PostEmbedCardState (+5 more)
...
### Community 69 - "MaterialPageRoute"
Cohesion: 0.20
...
### Community 73 - "_CommunityProfileScreenState"
Cohesion: 0.32
Nodes (8): eventsProvider, CommunityProfileScreen, _CommunityProfileScreenState, _openPlannedEvent, build, HomeScreen, newsProvider, votingProvider
...
### Community 77 - "favorites_screen.dart"
Cohesion: 0.29
...
### Community 84 - "eventsProvider"
Cohesion: 0.40
Nodes (6): communityAuthProvider, eventsProvider, build, EventsScreen, FavoritesScreen, openEntry
...
- **Why does `_LiveFeedScreenState` connect `communityServiceProvider` to `community_screen.dart`, `ConsumerState`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `build` connect `communityServiceProvider` to `community_screen.dart`, `MaterialPageRoute`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
