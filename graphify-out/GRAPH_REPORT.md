...
Cohesion: 0.08
Nodes (23): about_screen.dart, ../artists/artists_screen.dart, community_users_screen.dart, donate_screen.dart, faq_screen.dart, favorites_screen.dart, icon, onTap (+15 more)
...
### Community 28 - "communityServiceProvider"
Cohesion: 0.13
Nodes (22): ConsumerState, ConsumerStatefulWidget, communityServiceProvider, CommunityAdminScreen, _CommunityAdminScreenState, CommunityProfileScreen, _CommunityProfileScreenState, _delete (+14 more)
...
Cohesion: 0.14
Nodes (16): ConsumerWidget, communityAuthProvider, communityPostsProvider, watch, build, CommunityAvatarButton, _PostAuthorAvatar, build (+8 more)

### Community 41 - "MaterialPageRoute"
Cohesion: 0.14
Nodes (17): eventsProvider, newsProvider, _openAuthorProfile, _openPlannedEvent, _openProfile, _readOnlyProfileWidgets, _special, build (+9 more)
...
### Community 43 - "news_detail_screen.dart"
Cohesion: 0.12
...
### Community 44 - "main_navigation.dart"
Cohesion: 0.12
...
### Community 53 - "favorites_screen.dart"
Cohesion: 0.17
...
### Community 61 - "voting_service.dart"
Cohesion: 0.18
...
### Community 63 - "voting_screen.dart"
Cohesion: 0.18
...
- **Why does `CommunityService` connect `ConsumerWidget` to `community_users_screen.dart`, `community_screen.dart`, `community_service.dart`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `communityServiceProvider` connect `communityServiceProvider` to `ConsumerWidget`, `MaterialPageRoute`, `_EventSubmissionScreenState`, `_VotingScreenState`?**
