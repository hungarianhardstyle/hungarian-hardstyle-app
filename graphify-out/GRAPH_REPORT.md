...
## Corpus Check
- 156 files · ~260,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1935 nodes · 2576 edges · 117 communities (107 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afedba4a`
...
Cohesion: 0.02
Nodes (84): accessAdmin, accessModerator, accessNone, accountRole, adminBlockUser, adminEmail, _anonymousNumber, _attendance (+76 more)
...
Cohesion: 0.06
Nodes (40): DocumentSnapshot, _Composer, _ProfileAvatar, _ArtistLinks, _Section, _action, CommunityBlockedUsersScreen, CommunityConnectionsScreen (+32 more)
...
Cohesion: 0.16
Nodes (15): eventsProvider, newsProvider, _openAuthorProfile, _openPlannedEvent, _openProfile, _readOnlyProfileWidgets, build, _artistContent (+7 more)
...
Cohesion: 0.28
Nodes (9): ConsumerWidget, communityAuthProvider, CommunityAvatarButton, _PostAuthorAvatar, build, EventsScreen, build, MoreScreen (+1 more)
...
Cohesion: 0.18
Nodes (11): ../artists/artist_detail_screen.dart, ../events/event_detail_screen.dart, favoritesProvider, build, FavoritesScreen, _label, _OrganizerContent, build (+3 more)
...
### Community 72 - "donate_screen.dart"
Cohesion: 0.40
...
## Knowledge Gaps
- **1182 isolated node(s):** `functions`, `{ onDocumentWritten }`, `{ defineSecret }`, `admin`, `{ getFirestore }` (+1177 more)
