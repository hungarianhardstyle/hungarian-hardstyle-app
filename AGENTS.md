...
- **Csomag:** **`build/huhs-mobile-api-2.12.0.zip`** — **47 fájl**, **167 005 bájt** (163,1 KB), SHA-256 **`7AAD9A34D138CE7F3A199F36BD7DC1CAEEC1A45C6A4F7B3EC76EFC35C07BACB1`** (a 2.11.0 46 fájlja + a `translation-cron.php`); a patch: **`docs/plugin-2.12.0-english-fields.patch`** (7 fájl, **+407/−49** sor, a **kiadott 2.11.0 ZIP-ből** kibontott bázishoz mérve, nem emlékezetből).
