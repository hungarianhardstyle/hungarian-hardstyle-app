...
- Backend package `2.4.24` is prepared locally. It accepts the v0.99 event address/end fields and Cloudinary image URLs, exposes Cloudinary-backed images after approval, and adds the WordPress API Lomtár and About admin menus; deployment and live verification are still pending.
