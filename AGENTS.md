...
- **⚠️ AMI MÉG NYITOTT (Console-only):** a **hír-deklaráció** (az app ad hírtartalmat → „news app" = igen), a **bírálói teszt-fiók** megadása (⚠️ **a legkritikusabb**: az app bejelentkezést kér, enélkül a bírálat nem tud belépni), és az **adatbiztonsági nyilatkozat** kitöltése a fióktörlési URL-lel.
