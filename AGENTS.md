...
### NYEREMÉNYJÁTÉK (kvíz) — implementálva, plugin 2.5.0 + AAB 322 + Firebase (2026-09-18)
...
- **Csomagok:** `build/huhs-mobile-api-2.5.0.zip` — 43 bejegyzés, 130,1 KB, SHA-256 `79EBFD48C3C9B44E061050E52297F3D572A153696CB60630CF1D94FCB497B0DB` (**ezt kell feltölteni**); `build/HUHS-v1.0.0+322-release.aab` (a tulajdonos tölti fel).
- **Sorrend, ami számít:** a plugin 2.5.0 **és** a `prizeVote`/`drawPrizeWinner` függvények is kellenek ahhoz, hogy a játék élesben működjön. Amíg a plugin nincs fent, a sorsoló függvény `prize_draw_pending_failed`-t naplóz (404), de ez ártalmatlan és magától megszűnik a feltöltés után.
