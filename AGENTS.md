...
- Backend package `2.4.25` is prepared locally. It includes `Happy Hardcore`, one-week/one-day/six-hour reminders, v0.99 event fields, numeric-only postal-code validation, Cloudinary image approval/admin previews, and the WordPress API Lomtár/About menus; deployment and live verification are still pending.
