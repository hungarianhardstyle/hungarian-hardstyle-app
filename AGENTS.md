...
- **📌 A TULAJDONOS LÉPÉSE:** a **2.14.1** feltöltése (a 2.14.0-t cseréli). Utána a **játék kártyája is angolul szól** — a fordítás már **el van tárolva** (a 2.14.0 pótló köre lefordította), ezért nincs új API-költség, csak ki kell olvasni. Az **Achievement-nevek** app-oldaliak (lásd a következő szakaszt).
