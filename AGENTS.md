...
- **Amit a javított szűrő azonnal talált (24 óra, ~730 ERROR):**
  ...
  - **NYITOTT, javaslat:** a label-szinkron **lényegi** lassítása az, hogy változatlan termékeket is újra felküld; egy „változatlan → kihagyás" jelölő (mint a push-fingerprint) tovább rövidítené. Ez külön döntés, mert a szinkron viselkedését érinti.
