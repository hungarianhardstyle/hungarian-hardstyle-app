...
- **📌 A TULAJDONOS LÉPÉSE:** a **2.14.0** feltöltése (a 2.13.0-t cseréli). Utána a hiányzó fordítások **magától** pótlódnak (óránkénti pótló kör), vagy egy paranccsal: `node tools/run-content-translation-sweep.mjs --rounds=20`. Az app **nem** igényel frissítést ehhez: a `?lang=en` paramétert már minden kérésre elküldi, és a cache is nyelvenként külön válik.
