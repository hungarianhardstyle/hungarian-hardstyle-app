...
- **📌 A TULAJDONOS LÉPÉSE:** a **359 feltöltése a zárt teszt sávra** a **`docs/PLAY-KIADASI-JEGYZET.md` 1. blokkjával**; a nyilvános kiadáshoz az **1b. blokk** (356–359 összesítő). **Miért 359 (mérve):** a zárt teszten a **358** van (`completed`, 100%), a production sávon a **355**. **iOS:** a 359 sideloadja külön kérésre megy (a CI-út készen áll).
