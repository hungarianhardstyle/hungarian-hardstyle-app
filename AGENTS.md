...
- **⚠️ ŐSZINTE KORLÁT:** futásidejű, **eszközön mért** igazolás nincs (a görgetés, a kijelölés, a szerkesztő űrlap és a képcsere a tulajdonos készülékén mérhető), és a **plugin 2.7.0 élő működése** csak a feltöltés után igazolható (`check-artist-claims.mjs --ping`, majd egy mentés az appból).
