...
- **📌 A TULAJDONOS LÉPÉSE:** (1) a **`build/huhs-mobile-api-2.10.0.zip`** feltöltése a WordPressre (**a 2.9.0-t cseréli**; ebben a 2.8.0 és a 2.9.0 javítása is benne van) — **enélkül a hírlevél továbbra is korlátlanul küldi a megerősítő levelet**; (2) a **`build/HUHS-v1.0.0+356-release.aab`** feltöltése a zárt teszt sávra; (3) eszközpróba: kétszer egymás után ugyanazzal a címmel feliratkozni → a második válasz azt írja, hogy már kiment; szavazás hozzájárulással → a szavazat akkor is be kell menjen, ha a hírlevél hibázik.
