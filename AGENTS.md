...
- **✅ A TULAJDONOS DÖNTÉSE (2026-09-24):** *„nézd meg a library-verziókat (csak kutatás)"* → **megtörtént, ez a szakasz az eredmény**. A kód és a kiadás **változatlan**; a további lépésről (parkolás / Firebase major kör / csak Android-oldali BoM-emelés) **külön döntés** születik.
