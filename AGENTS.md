...
- **NYITOTT / AMIT MÉG NEM TETTEM BE:** a kiadvány adatlapjáról nincs „Megnyitás a lejátszóban" gyorsgomb (a menüpont kész); a WAV-ok nagyok (50–100 MB), ezért a felület csak a letöltött összméretet mutatja, nem figyelmeztet méretre; a lejátszó sáv a képernyőn belül él (nem előtér-szolgáltatás), tehát az app elhagyásakor megáll — ez szándékos, hogy a rádióval ne ütközzön.
