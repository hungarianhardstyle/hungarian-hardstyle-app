...
- Backend package `2.4.26` is prepared locally. It includes `Happy Hardcore`, one-week/one-day/six-hour reminders, v0.99 event fields, numeric-only postal-code validation, Cloudinary image approval/admin previews, WordPress API Lomtár/About menus, and automatic address-based Google Maps links; deployment and live verification are still pending.
