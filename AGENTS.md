...
- **Csomag:** **`build/huhs-mobile-api-2.12.0.zip`** — **47 fájl**, **166 889 bájt** (163,0 KB), SHA-256 **`5AF7B83BB1188B3E834DCD9E7FD9FA9DC03AFB5BEB9AD0F9D1758AB55420DF08`** (a 2.11.0 46 fájlja + a `translation-cron.php`); a patch: **`docs/plugin-2.12.0-english-fields.patch`** (7 fájl, **+406/−52** sor, a **kiadott 2.11.0 ZIP-ből** kibontott bázishoz mérve, nem emlékezetből).
