...
console.log(
  `tmp/changelog-en-5.mjs: ${latest.release373.length + latest.release372.length + latest.release371.length + latest.release370.length + latest.release369.length + latest.release368.length} sor (a legfrissebb kiadások)`,
);
