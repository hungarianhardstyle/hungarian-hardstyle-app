...
- **Kiadásra kész:** `build/HUHS-v1.0.0+332-release.aab` (versionCode **332**, 79,50 MB, SHA-256 `BD7130B553372300F22E43B8EE708003DB2C796ED19449568E451920DB098AA4`) és `build/huhs-mobile-api-2.5.7.zip` (SHA-256 `352223459F8DC5318321303B8BF835623AE8856465F15412E03D5002F744F2E9`). A Play-be másolható kiadási szöveg: `docs/PLAY-KIADASI-JEGYZET.md`. **A 332-t kell feltölteni** (a 329, a 330 és a 331 soha nem ment ki) — a plugin 2.5.7 már fent van, azt nem kell újra.
...
- **Új kapuk:** `tools/verify-native-admin-menu.mjs` (a natív admin menüpontjai ↔ a plugin végpontjai), `tools/check-play-notes.mjs` (a kiadási szöveg), `tools/verify-achievement-points.mjs` (az achievement-invariáns ÉLES mérése) és `tools/restore-lost-achievement-points.mjs` (az elveszett pontok visszaállítása előnézettel és `--confirm`-mal).
