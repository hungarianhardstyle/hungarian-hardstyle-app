...
- Current Flutter build: `0.99.3+4`; v0.99.3 remains the HUHS Vezérlőközpont and security-hardening target.
- Flutter ARM debug build succeeded; `flutter analyze --no-pub` reports one existing non-blocking info and all 26 tests pass.
- ARM64 debug APK built at `build/huhs-v0.99.3+4-arm64-debug.apk`.
