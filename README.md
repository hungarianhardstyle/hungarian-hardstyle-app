...
## Aktuális állapot — 2026-09-19 (AAB **332** + plugin **2.5.7**)

- **Kiadásra kész ÉS ÉLES:** `build/HUHS-v1.0.0+332-release.aab` (versionCode **332**, 79,50 MB, SHA-256 `BD7130B553372300F22E43B8EE708003DB2C796ED19449568E451920DB098AA4`) és `build/huhs-mobile-api-2.5.7.zip` (SHA-256 `352223459F8DC5318321303B8BF835623AE8856465F15412E03D5002F744F2E9`). A Play-be másolható kiadási szöveg: `docs/PLAY-KIADASI-JEGYZET.md`. **A 332 fent van a zárt teszt (alpha) sávján, `completed` állapotban** — ezt a `node tools/check-play-track.mjs` méri a Play Developer API-ból (production/beta üres; a zárt teszt sávján egyszerre egy kiadás él).
- **A 332 újdonsága:** a **görgetés közbeni villogás javítva** (a hírek, DJ-k és események képei áttűnés nélkül jelennek meg — eddig minden lista-újraépítés újraindította a beépített áttűnési animációt), és **a napi lájkpont-keret jelzése**: ha a napi 3 lájkpont elfogyott, az app a lájk előtt kiírja, hogy „A mai lájkpontod elfogyott.".
