...
- **Kiadásra kész:** `build/HUHS-v1.0.0+331-release.aab` (versionCode **331**, SHA-256 `6D5798840E5C47EA6AB7DF54B2BB1C2A3767016E89BCD3B4326158973EC85336`) és `build/huhs-mobile-api-2.5.7.zip` (SHA-256 `352223459F8DC5318321303B8BF835623AE8856465F15412E03D5002F744F2E9`). A Play-be másolható kiadási szöveg: `docs/PLAY-KIADASI-JEGYZET.md`. **A 331-et kell feltölteni** (a 329 és a 330 soha nem ment ki) — **és a plugin 2.5.7-et is**, mert a létrehozás az új végpontjait használja.
...
- **A plugin 2.5.7** viszi a létrehozó-végpontokat (`includes/admin-create.php`): a mezők kulcsa a valódi meta-kulcs, a validáció a szerveren is fut (2–6, illetve 3–5 válasz; kvíznél a hibás kérdés sorszáma megjelenik), a `_huhs_prize_correct` 1-alapú sorszámát a szerver fordítja 0-alapú indexre. A 2.5.6 éles ellenőrzése: `apiVersion=2.5.6`, a `prize_games`/`prize_results` valódi adatot ad UID/hash nélkül. **⚠️ A plugin forrása gitignore-olt munkafában él (`.tmp-api-*`), ezért a repóban csak a ZIP látszik.**
