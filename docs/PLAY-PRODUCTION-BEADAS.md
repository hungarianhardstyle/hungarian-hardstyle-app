...
| Következő csomag | **356** (hírlevél: nem megy ki újra a megerősítő e-mail + a Play „teljes képernyős mód" javaslatának megfelelő `enableEdgeToEdge()`; a 355 nyeremény-javításait, a 354 DJ-megjelenéseit és a 353 Firebase major emelését is tartalmazza): `build/HUHS-v1.0.0+356-release.aab`, plugin **2.10.0** | `check-play-notes.mjs` |
