      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _LinkTile(icon: Icons.facebook, label: 'Facebook', value: 'Hungarian Hardstyle', onTap: () => openInAppBrowser(context, 'https://www.facebook.com/Hunstyle')),
            _LinkTile(icon: Icons.camera_alt_outlined, label: 'Instagram', value: '@hungarianhardstyle', onTap: () => openInAppBrowser(context, 'https://www.instagram.com/hungarianhardstyle/')),
            _LinkTile(icon: Icons.music_note, label: 'TikTok', value: '@hungarianhardstyle', onTap: () => openInAppBrowser(context, 'https://www.tiktok.com/@hungarianhardstyle')),
            _LinkTile(icon: Icons.smart_display_outlined, label: 'YouTube', value: 'Hungarian Hardstyle', onTap: () => openInAppBrowser(context, 'https://www.youtube.com/@HungarianHardstyle')),
